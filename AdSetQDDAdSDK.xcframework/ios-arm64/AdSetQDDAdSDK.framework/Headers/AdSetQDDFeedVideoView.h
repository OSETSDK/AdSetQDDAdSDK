...
#import "AdSetQDDFeedAdMeta.h"
#import "AdSetQDDFeedVideoConfig.h"
#import "AdSetQDDFeedVideoDelegate.h"
#import "AdSetQDDFeedVideoInterface.h"

NS_ASSUME_NONNULL_BEGIN

@interface AdSetQDDFeedVideoView : UIView
/// 回调代理
@property(nonatomic,weak) id<AdSetQDDFeedVideoDelegate> delegate;
/// 视频广告配置
@property(nonatomic,strong) AdSetQDDFeedVideoConfig *videoConfig;
/// 展示广告的视图控制器
@property(nonatomic,weak) UIViewController *presentVc;

-(instancetype) initWithFrame:(CGRect)frame
                     delegate:(id<AdSetQDDFeedVideoDelegate>)delegate
                       config:(AdSetQDDFeedVideoConfig*)config
 ...
 */
- (void)setMediaCustomFeedVideoView:(id<AdSetQDDFeedVideoInterface>)videoView;
/**
