...
#import "AdSetQDDVideoAdDelegate.h"
#import "AdSetQDDBaseViewAd.h"

NS_ASSUME_NONNULL_BEGIN

@interface AdSetQDDVideoAd : AdSetQDDBaseViewAd
/**
 * 贴片基础回调代理
 */
@property (nonatomic, weak) id<AdSetQDDVideoAdDelegate> delegate;
/**
 * 贴片扩展回调代理 如不需要扩展回调相关功能，可不用指定
 */
@property (nonatomic, weak) id<AdSetQDDVideoAdExtensionFunctionDelegate> extDelegate;
/**
 * 加载广告
 @param pid             广告位id  必传
 @param adParams  广告参数  必传
 */
- (void)loadAdWithPid:(NSString *)pid adConfigParams:(AdSetQDDVideoAdConfigParams *)adParams;
/**
 * 展示广告
 */
