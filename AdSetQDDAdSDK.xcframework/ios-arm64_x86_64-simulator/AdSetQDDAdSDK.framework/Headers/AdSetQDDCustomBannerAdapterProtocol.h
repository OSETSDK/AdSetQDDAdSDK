//
//  AdSetQDDCustomBannerAdapterProtocol.h
//  AdSetQDDAdSDK
//
...
#import "AdSetQDDCustomBannerEventProtocol.h"

NS_ASSUME_NONNULL_BEGIN

@protocol AdSetQDDCustomBannerAdapterProtocol <AdSetQDDCustomAdapterProtocol>
...
- (UIView *)loadAndShow:(NSString *)pid
            ...
            bannerEvent:(id<AdSetQDDCustomBannerEventProtocol>)event;
/**
  渲染广告
 */
- (void)renderAd;
