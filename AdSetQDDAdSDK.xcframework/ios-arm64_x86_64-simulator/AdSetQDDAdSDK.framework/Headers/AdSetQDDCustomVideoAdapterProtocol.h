//
//  AdSetQDDCustomVideoAdapterProtocol.h
//  AdSetQDDAdSDK
//
...
#import "AdSetQDDCustomVideoEventProtocol.h"

NS_ASSUME_NONNULL_BEGIN

@protocol AdSetQDDCustomVideoAdapterProtocol <AdSetQDDCustomAdapterProtocol>
...
- (UIView *)loadAndShow:(NSString *)pid
             ...
             videoEvent:(id<AdSetQDDCustomVideoEventProtocol>)event;
/**
  渲染广告
 */
- (void)renderAd;
