//
//  AdSetQDDCustomDrawAdapterProtocol.h
//  AdSetQDDAdSDK
//
...
#import "AdSetQDDCustomDrawEventProtocol.h"

NS_ASSUME_NONNULL_BEGIN

@protocol AdSetQDDCustomDrawAdapterProtocol <AdSetQDDCustomAdapterProtocol>
...
- (void)loadAdPid:(NSString *)pid
           ...
           videoEvent:(id<AdSetQDDCustomDrawEventProtocol>)event;
/**
  渲染广告
 */
- (void)renderAd;
