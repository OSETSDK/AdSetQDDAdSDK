//
//  AdSetQDDBaseAdConfigParams.h
//  AdSetQDDAdSDK
//
//  Created by AdSetQDD on 2023/2/14.
...
typedef NS_ENUM(NSInteger,AdSetQDDRewardAdShowDirection) {
    AdSetQDDRewardAdShowVerticalDirection   = 0,     //竖屏
    AdSetQDDRewardAdShowHorizontalDirection = 1,     //横屏
};

@interface AdSetQDDBaseAdConfigParams : NSObject
/**
 server bidding注意点⚠️
...
@end
#pragma mark 开屏广告参数
@interface AdSetQDDSplashAdConfigParams : AdSetQDDBaseAdConfigParams
/**
 开屏广告容器尺寸（默认屏幕size）
 adSize传值提示：
 1、全屏展示传屏幕size即可
...
#pragma mark 激励视频参数
@interface AdSetQDDRewardAdConfigParams : AdSetQDDBaseAdConfigParams
/**
...
/**
 ...
 支持平台 快手
 */
@property(nonatomic,assign)AdSetQDDRewardAdShowDirection direction;

@end

#pragma mark 横幅banner广告参数
@interface AdSetQDDBannerAdConfigParams : AdSetQDDBaseAdConfigParams
/**
...
#pragma mark 插屏广告参数
@interface AdSetQDDInterstitialAdConfigParams : AdSetQDDBaseAdConfigParams
/**
 * 是否静音，默认 YES。
 * 设置时机：加载广告前。
...
@interface AdSetQDDNativeFeedAdConfigParams : AdSetQDDBaseAdConfigParams
/**
 * 加载广告条数 默认1条
 * 传入时机：加载广告前
 */
...
#pragma mark 全屏视频参数
@interface AdSetQDDExpressFullScreenVideoAdConfigParams : AdSetQDDBaseAdConfigParams
/**
 *  是否静音，默认 YES。
 *  设置时机：加载广告前设置。
 *  仅 快手 AdSetQDD平台设置有效
...
@interface AdSetQDDDrawAdConfigParams : AdSetQDDBaseAdConfigParams
/**
 指定广告view size
 默认全屏尺寸
 传入时机：加载广告前传入
...
#pragma mark 贴片广告参数
@interface AdSetQDDVideoAdConfigParams : AdSetQDDBaseAdConfigParams
/**
